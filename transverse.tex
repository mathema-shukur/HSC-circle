...
\begin{document} 
	...
	\\
	সাধারণ স্পর্শকের স্পর্শ বিন্দুদ্বয় বৃত্তের কেন্দ্রদ্বয়ের সংযোজক রেখার একই পার্শ্বে অবস্থিত হলে তাকে সরল সাধারণ স্পর্শক বলে \\ 
	\\
	...
	\end{tikzpicture}\\
	\\ 
	পরস্পরচ্ছেদী নয় এমন  দুইটি বৃত্তের তীর্যক সাধারণ স্পর্শক $EF$ ও $GH$ \\
	\\
	সাধারণ স্পর্শকের স্পর্শ বিন্দুদ্বয় কেন্দ্রদ্বয়ের সংযোজক রেখার বিপরীত পার্শ্বে অবস্থিত হলে তাকে তীর্যক সাধারণ স্পর্শক বলে। \\
	...
	\end{tikzpicture}\\
	\\
প্রশ্নঃ \textcolor{blue}{	$x^2+y^2=16$ এবং  $x^2+y^2+6x-8y=0$ বৃত্ত দুইটির সরল সাধারণ স্পর্শক দুইটির সমীকরণ নির্ণয় কর}\\ 
	\\
	\begin{align*}
		x^2+y^2+6x-8y&=0\\
		\\
	...
	\end{tikzpicture}\\
	\\
	$C_1(-3,4)$ ও $C_2(0,0)$ কেন্দ্রদ্বয়ের সংযোগ রেখাংশ $A(x',y')$ বিন্দুতে  $r_1:r_2=5:4$ অনুপাতে বহিঃস্থ ভাবে বিভক্ত করে। AB ও AC  সরল সাধারণ স্পর্শক \\ 
\\ 
...
প্রশ্নঃ \textcolor{blue}{ দেখাও যে, $x^2+y^2-2x+4y-31=0$ এবং $x^2+y^2+4x-4y+7=0$ বৃত্তদ্বয় পরস্পরকে অন্তঃস্থ ভাবে স্পর্শ করে। সাধারণ স্পর্শক ও স্পর্শ বিন্দুর স্থানাঙ্ক নির্ণয় কর }\\ 
	...
	\end{tikzpicture}\\
	\\ 
	$C_1(1,-2)$ ও $C_2(-2,2)$ কেন্দ্রদ্বয়ের মধ্যবর্তী দূরত্ব \\
	\begin{align*}
	...
	\end{align*}\\
\\
 ব্যাসার্ধদ্বয়ের বিয়োগফল $|r_1-r_2|=|6-1|=5$\\
 \\
 সুতরাং কেন্দ্রদ্বয়ের মধ্যবর্তী দূরত্ব=  ব্যাসার্ধদ্বয়ের বিয়োগফল\\
 \\ 
 বৃত্ত দুইটি পরস্পরকে অন্তঃস্থ ভাবে স্পর্শ করে \\
 \\ 
 বৃত্ত দুইটির সাধারণ স্পর্শকের সমীকরণ \\ 
	\begin{align*}
		S_1-S_2&=0\\
		\\
	...
	\end{align*}
\\
	বৃত্ত দুইটির সাধারণ স্পর্শকের সমীকরণ $3x-4y+19=0$\\
	\\
	$C_1(1,-2)$ ও  $C_2(-2,2)$ সংযোগ রেখার সমীকরণ \\ 
	\begin{align*}
	...
	\end{align*}
\\
EQ01 ও EQ02 সমাধান করে পাই \\
\\
$x=-\frac{13}{5}$, $y=\frac{14}{5}$\\
\\
স্পর্শ বিন্দুর(P) স্থানাঙ্ক $\left(-\frac{13}{5},\frac{14}{5}\right)$\\
\\
\begin{tikzpicture}
	...
	\draw[color=red, domain=-2:2] plot (\x,{(\x)^2}) node[right] {$y = x^2$};
	\draw[color=orange, domain=0:4] plot (\x,{(\x)^0.5}) node[right] {$y^2 = x$};
	\draw[color=orange, domain=0:4] plot (\x,-{(\x)^0.5}) node[right] {};
